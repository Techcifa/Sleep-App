            ...
            {!session ? (
              ...
              <div className="space-y-5">
                <div className="text-center py-2">
                  <p className="text-sm text-stone-500 dark:text-stone-400 leading-relaxed">Sign in to sync your sleep data across devices and unlock all features.</p>
                </div>
